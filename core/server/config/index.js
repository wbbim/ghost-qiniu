...
ConfigManager.prototype.set = function (config) {
    ...
    if (this._config.qiniu) {
        configWild.qiniu = {
            bucketname: this._config.qiniu.bucketname,
            ACCESS_KEY: this._config.qiniu.ACCESS_KEY,
            SECRET_KEY: this._config.qiniu.SECRET_KEY,
            root: this._config.qiniu.root,
            prefix: this._config.qiniu.prefix
        }
    }

    _.merge(this._config, configWild);
